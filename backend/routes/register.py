...
def register_routes(app):
    ...
    main_bp.register_blueprint(dashboard_front, url_prefix='/dashboard')
    ...
    main_bp.register_blueprint(reviews_front, url_prefix='/resenias_front')
